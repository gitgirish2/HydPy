...
logger = logging.getLogger('philhues')
...
class philhuesException(Exception):
...
class philhuesRegistrationException(philhuesException):
    pass


class philhuesRequestTimeout(philhuesException):
    pass
...
class Bridge(object):
    ...
    You can obtain Light objects by calling the get_light_objects method:
        ...
        >>> b.get_light_objects()
        [<philhues.Light at 0x10473d750>,
         <philhues.Light at 0x1046ce110>]
    ...
    def request(self, mode='GET', address=None, data=None):
        ...
        try:
            ...
            raise philhuesRequestTimeout(None, error)
        ...
        for line in response:
            for key in line:
                ...
                if 'error' in key:
                    ...
                    if error_type == 101:
                        raise philhuesRegistrationException(error_type,
                                                        'The link button has not been pressed in the last 30 seconds.')
                    if error_type == 7:
                        raise philhuesException(error_type,
                                            'Unknown username')
...
if __name__ == '__main__':
    ...
    while True:
        try:
            ...
            break
        except philhuesRegistrationException as e:
            if PY3K:
